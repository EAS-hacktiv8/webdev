...
<head>
    ...
    <link href="{{ asset('css/company_styles.css') }}" rel="stylesheet" type="text/css">
</head>
            ...
            <div class="row gx-5 justify-content-center">
                <div class="col-lg-6">
                    <div class="text-center my-5">
                        <h1 class="display-5 fw-bolder text-white mb-2">We offer modern solutions for growing your
                            business</h1>
                        <p class="lead text-white-50 mb-4">We are team of talented designers making websites with
                            Bootstrap, the world’s most popular front-end open source toolkit!</p>
                        <div class="d-grid gap-3 d-sm-flex justify-content-sm-center">
                            <button type="button" class="btn btn-primary btn-lg px-4 me-sm-3" data-bs-toggle="modal" data-bs-target="#modalOrder">Order Now</button>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="modalOrderLabel">Modal title</h1>
                ...
                <div class="modal-body">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>---</td>
                                <td><a class="btn btn-dark btn-sm" href="#!">Order Now</a></td>
                                <td><a class="btn btn-dark btn-sm" href="#!">Order Now</a></td>
                                <td><a class="btn btn-dark btn-sm" href="#!">Order Now</a></td>
                            </tr>
                        </tbody>
